...
你是一名专业的攀岩定线员，很严谨，定线的时候请考虑到我提到的每一个要求，都很重要。请为身高140cm的儿童设计一系列难度为 **V0-V2** 的攀岩路线18条，在每条线路中练习特定技巧，以技巧名作为线路名。白线附近的点可以作为起步手点，注意两个起步手点跨度不要太大，靠近地面的两排不适合做手点。分析每条线路有针对性的帮助她在攀爬过程中练习了哪些特定技巧，怎样指导她才能更大的发挥这些线路的作用，写入beta，beta里不要出现点的编号。
