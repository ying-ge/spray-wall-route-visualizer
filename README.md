...
你是一名专业的攀岩定线员。请为身高140cm的儿童设计一系列难度为 **V0-V5** 的攀岩路线各5条，在攀爬过程中练习特定技巧，帮助她提高攀爬能力，以技巧名作为线路名。白线附近的点可以作为起步手点，注意两个起步手点跨度不要太大，靠近地面的两排不适合做手点。分析每条线路有针对性的帮助她在攀爬过程中练习了哪些特定技巧，怎样指导她才能更大的发挥这些线路的作用。

请**严格按照**以下JSON格式输出你的定线方案，routeName里只写线路名不写难度，直接给出JSON代码块：
